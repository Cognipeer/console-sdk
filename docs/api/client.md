...
If you need the raw HTTP endpoint names behind each resource, see [Console API Mapping](/api/console-mapping) and the [Cognipeer Console API Reference](https://cognipeer.github.io/cognipeer-console/api/overview).
...
See [Memory API](/api/memory) for details.
