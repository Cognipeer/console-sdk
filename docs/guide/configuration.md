...
**Default**: `https://console.cognipeer.com/api/client/v1`
...
function createClient(options: {
  ...
  const baseURLs = {
    ...
    production: 'https://console.cognipeer.com/api/client/v1',
  };
...
COGNIPEER_BASE_URL=https://console.cognipeer.com/api/client/v1
