...
If you are looking for deployment, tenancy, providers, or raw endpoint behavior, start with the [Cognipeer Console docs](https://cognipeer.github.io/cognipeer-console/) first.
...
const client = new ConsoleClient({
  apiKey: 'your-api-key',
  baseURL: 'https://your-console.example.com/api/client/v1', // Optional: custom Console client API URL
...
- [Working with Console](/guide/working-with-console) - Understand the split between Console platform docs and SDK docs
...
- [Console API Mapping](/api/console-mapping) - Map SDK methods to the underlying Console endpoints
